function [Bmus,DotPr] = som_bmusDP(sMap, sData, which_bmus, mask)
%this function is modified som_bmus
%author of modifications of the function som_bmus from SOM toolbox (http://www.cis.hut.fi/projects/somtoolbox/)- Zdenek Straka

%calculation of bmus is based on dot product instead of norms of difference
%input vector and synaptic weight vector
%some functionality of original som_bmus was not tested in the current version so may be nonfunctional
%find word change
...
Bmus=BmusPom(which_bmus,:)';
DotPr=DotPrPom(which_bmus,:)';
% % % 
