function vizuRF3ZOOMAdGaps(sM,TaxPos,Mtest,xLeftTopCorn,yLeftTopCorn,xRightLowerCorn,yRightLowerCorn,varargin)
...
vizuRFPom(M,TaxPos,sM,threshold,xLeftTopCorn,yLeftTopCorn,xRightLowerCorn,yRightLowerCorn,markerSizeRed,markerSizeGreen,tightVer,tightParams);

function vizuRFPom(M,TaxPos,sM,thresho,xLeftTopCorn,yLeftTopCorn,xRightLowerCorn,yRightLowerCorn,markerSizeRed,markerSizeGreen,tightVer,tightParams)
...
for i=1:m
 ...
 subtightplot(yRightLowerCorn-yLeftTopCorn+1,xRightLowerCorn-xLeftTopCorn+1,(i-(yLeftTopCorn))*(xRightLowerCorn-xLeftTopCorn+1)+j-(xLeftTopCorn-1),tightParams{:})   
 else
